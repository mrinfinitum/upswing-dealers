...
export default async function ImageGalleryPage() {
  ...
  try {
    ...
    const diagnostic = error instanceof DropboxApiError ? { name: error.name, status: error.status } : { name: error instanceof Error ? error.name : "UnknownError" };
  ...
  return <div className="image-gallery-page">
    ...
    {!configurationMissing && !providerUnavailable && images.length ? <ImageGallery images={images} canManageCategories={identity.role === "admin"} /> : null}
