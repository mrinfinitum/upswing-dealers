...
const administrationLinks = [
  { href: "/admin/dealers", eyebrow: "Dealer network", title: "Dealer Admin", description: "Choose a retailer, then manage only that dealer’s locations." },
  { href: "/admin/users", eyebrow: "Access control", title: "User Admin", description: "Manage user accounts, groups, dealer access, and page permissions." },
  { href: "/admin/gallery", eyebrow: "Media library", title: "Gallery Admin", description: "Browse and download approved imagery from the connected Dropbox library." },
];

const reservedSections = [
  { href: "/admin/brand", eyebrow: "Brand resources", title: "Brand Admin", description: "Manage approved brand standards, dealer downloads, and shared marketing assets." },
];
