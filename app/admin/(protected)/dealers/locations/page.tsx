  ...
  return (
    <div className="admin-page admin-dealer-locations-page">
      ...
      <section className="admin-dealer-portal-hero">
        ...
        <Link className="admin-button admin-button--light" href={`/admin/locations/new?dealer=${encodeURIComponent(dealerName)}`}>Add location <span aria-hidden="true">＋</span></Link>
      </section>
