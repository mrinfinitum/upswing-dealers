    ...
    <div className="admin-page admin-users-page">
      ...
      {setupError ? <section className="admin-setup"><h2>User directory unavailable</h2><p>{setupError}</p></section> : <>
        ...
        <section className="admin-user-directory">
          ...
          <div className="admin-user-create"><div><p className="eyebrow">User access</p><h3>Create user</h3><p>Invite a user by email or create an account directly. Dealers can be assigned to an organization with access to only the portal pages they need.</p></div><AddUserForm organizations={activeOrganizations} /></div>
