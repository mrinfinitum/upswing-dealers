...
assert.match(adminShell, /href="\/image-gallery"/, "Image Gallery is available in primary admin navigation");
...
assert.match(adminDashboard, /href: "\/image-gallery"/, "the shared Image Gallery appears on the admin hub");
assert.match(adminBrandPage, /Coming soon/, "the Brand Portal route has a reserved workspace state");
assert.match(adminGalleryPage, /redirect\("\/image-gallery"\)/, "the legacy admin gallery redirects to the canonical gallery route");
